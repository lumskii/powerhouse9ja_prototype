...
import { UserIcon, ShieldIcon, BellIcon, HelpCircleIcon, LogOutIcon, MoonIcon, SunIcon, TrophyIcon, CopyIcon } from 'lucide-react';
        ...
        <div className="max-w-md mx-auto space-y-6">
          ...
          <Card className="text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-gray-100 dark:bg-gray-700 px-4 py-2 rounded-full mb-4">
              ...
              <button onClick={handleCopyUserId} className="p-1 hover:bg-gray-200 dark:hover:bg-gray-600 rounded transition-colors active:scale-95" aria-label="Copy User ID">
